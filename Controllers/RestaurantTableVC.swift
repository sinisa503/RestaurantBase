...
class RestaurantTableVC: UITableViewController, NSFetchedResultsControllerDelegate {
    ...
    func configureCell(_ cell: CustomTableVCell, withEvent event: Event) {
        cell.nameLabel.text = event.timestamp!.description
        cell.addressLabel.text = event.timestamp!.description
    }
    ...
    func controller(_ controller: NSFetchedResultsController<NSFetchRequestResult>, didChange anObject: Any, at indexPath: IndexPath?, for type: NSFetchedResultsChangeType, newIndexPath: IndexPath?) {
        switch type {
            ...
            case .update:
                self.configureCell(tableView.cellForRow(at: indexPath!)! as! CustomTableVCell, withEvent: anObject as! Event)
            case .move:
...
extension RestaurantTableVC {
    
    func updateDatabase(restaurant: Restaurant) {
